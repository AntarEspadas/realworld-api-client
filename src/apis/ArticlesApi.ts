...
export class ArticlesApi extends runtime.BaseAPI {
     ...
     * Create an article
     */
    async createArticleRaw(requestParameters: CreateArticleOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<InlineObject3>> {
     ...
     * Create an article
     */
    async createArticle(requestParameters: CreateArticleOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<InlineObject3> {
     ...
     */
    async getArticlesRaw(requestParameters: GetArticlesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<InlineObject4>> {
        const queryParameters: any = {};
     ...
     * Get recent articles globally
     */
    async getArticles(requestParameters: GetArticlesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<InlineObject4> {
